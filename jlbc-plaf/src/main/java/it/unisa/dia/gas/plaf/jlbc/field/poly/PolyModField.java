...
//        if (order.compareTo(BigInteger.ZERO) != 0)
    ...
    public boolean equals(Object o) {
        ...
        PolyModField that = (PolyModField) o;

        if (n != that.n) return false;
        if (irreduciblePoly != null ? !irreduciblePoly.equals(that.irreduciblePoly) : that.irreduciblePoly != null)
            return false;
        if (nqr != null ? !nqr.equals(that.nqr) : that.nqr != null) return false;
    ...
    @Override
    public int hashCode() {
        int result = irreduciblePoly != null ? irreduciblePoly.hashCode() : 0;
        result = 31 * result + (nqr != null ? nqr.hashCode() : 0);
